        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="flex flex-col">
            <div className="flex items-center gap-2 group cursor-pointer mb-4">
              <span className="text-2xl font-bold">OSbytes</span>
              <CircleArrowOutUpRight className="group-hover:rotate-45 transition-transform duration-300" />
            </div>
            <p className="mb-4">
              Questions? Reach us <br /> Monday – Friday from 9 am to 6 pm
            </p>
            <h3 className="text-lg font-semibold">+1 001 234 5678</h3>
            <Link href="/contact">
              <button className="mt-4 py-2 px-4 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition duration-300">
                Request for quote
              </button>
            </Link>
          </div>
          ...
          <div className="space-y-2">
            <h3 className="text-lg font-semibold mb-4">{SOCIALS.title}</h3>
